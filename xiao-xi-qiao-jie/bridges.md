...
![image](../.gitbook/assets/bridge_mqtt.png)
...
![image](../.gitbook/assets/bridge_rpc.png)
...
![image](../.gitbook/assets/bridge_kafka.png)
...
{% hint style="info" %}
默认 payload 被 base64 编码，可通过修改配置 bridge.kafka.encode\_payload\_type 指定 payload 数据格式。
{% endhint %}
...
![image](../.gitbook/assets/bridge_rabbit.png)

RabbitMQ 桥接插件配置文件: etc/plugins/emqx\_bridge\_rabbit.conf。
...
![image](../.gitbook/assets/bridge_pulsar.png)
...
{% hint style="info" %}
默认 payload 被 base64 编码，可通过修改配置 bridge.pulsar.encode\_payload\_type 指定 payload 数据格式。
{% endhint %}
...
![image](../.gitbook/assets/bridge_rocket.png)
...
{% hint style="info" %}
默认 payload 被 base64 编码，可通过修改配置 bridge.rocket.encode\_payload\_type 指定 payload 数据格式。
{% endhint %}
