...
![image-20200217154254202](../.gitbook/assets/image-20200217154254202.png)
...
![\_images/guide\_2.png](../.gitbook/assets/guide_2.png)

{% hint style="info" %}
同时只启用一个认证插件可以提高客户端身份认证效率。
{% endhint %}

## TLS 认证 <a id="auth-tls"></a>
