...
同时具有多条 ACL 规则时，EMQ X 将按照规则排序进行合并，以 [ACL 文件](https://github.com/wivwiv/emqx-docs-cn/tree/f1b74f7ddf076e058060a68d35da71c6a6661992/advanced/acl-file.md) 中的默认 ACL 为例，ACL 文件中配置了默认的 ACL 规则，规则从下至上加载：
...
配置默认 [ACL 文件](https://github.com/wivwiv/emqx-docs-cn/tree/f1b74f7ddf076e058060a68d35da71c6a6661992/advanced/acl-file.md)，使用文件定义默认 ACL 规则：
...
参见 [HTTP API - 清除 ACL 缓存](../http-api/http-api.md#endpoint-get-acl-cache)
...
![\_images/guide\_3.png](../.gitbook/assets/guide_3.png)
