...
![image-20200217154254202](../.gitbook/assets/image-20200217154254202%20%281%29.png)

::: tip 写入数据的加盐规则、哈希方法与对应插件的配置一致时认证才能正常进行。更改哈希方法会造成现有认证数据失效。 :::
...
![\_images/guide\_2.png](../.gitbook/assets/guide_2%20%281%29.png)
...
如果希望使用 PSK 认证，需要将 [TLS 认证](auth.md#auth-tls) 中的 `listener.ssl.external.ciphers` 注释掉，然后配置 `listener.ssl.external.psk_ciphers`：
