...
关于 Dashboard 的详细配置项说明，请参见 [配置项](../can-shu-pei-zhi/configuration.md)。
...
![image](../.gitbook/assets/dashboard-overview.png)
...
![image](../.gitbook/assets/dashboard-clients-basic-info.png)
...
![image](../.gitbook/assets/dashboard-clients-subscriptions.png)
...
![image](../.gitbook/assets/dashboard-websocket.png)

#### HTTP API

`HTTP API` 页面列举了 EMQ X 目前支持的所有 HTTP API 及其说明：

![image](../.gitbook/assets/dashboard-http-api.png)
