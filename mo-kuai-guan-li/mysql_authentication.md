...
打开MySQL官网:[https://dev.MySQL.com/downloads/MySQL/5.7.html\#downloads](https://dev.MySQL.com/downloads/MySQL/5.7.html#downloads), 选择自己需要的版本，这里我们选择MySQL版本为macos-5.7.31

![image-20200928093151808](../.gitbook/assets/auth_mysql1.png)
...
![image-20200928094942950](../.gitbook/assets/auth_mysql2.png)

需要配置MySQL的地址，用户名，密码（可选）等基本连接参数表

![image-20200928095050885](../.gitbook/assets/auth_mysql3.png)

最后点击“添加”按钮，模块即可添加成功

![image-20200928095050885](../.gitbook/assets/auth_mysql4.png)
...
1. 查询结果中必须包含 is\_superuser 字段，is\_superuser 应该显式的为 true
