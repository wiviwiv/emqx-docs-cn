...
![image](../.gitbook/assets/mysql_init_1@2x.png)
...
![image](../.gitbook/assets/rule_sql%20%281%29.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 MySQL”。

![image](../.gitbook/assets/rule_action_1@2x.png)
...
![image](../.gitbook/assets/rule_action_2@2x.png)
...
![image](../.gitbook/assets/rule_action_3@2x.png)

点击 “新建” 按钮。

返回响应动作界面，点击 “确认”。

![image](../.gitbook/assets/rule_action_4@2x.png)

返回规则创建界面，点击 “创建”。

![image](../.gitbook/assets/rule_overview_1@2x.png)

在规则列表里，点击 “查看” 按钮或规则 ID 连接，可以预览刚才创建的规则:

![image](../.gitbook/assets/rule_overview_2@2x.png)
...
![image](../.gitbook/assets/mysql_result_1@2x.png)
...
![image](../.gitbook/assets/rule_sql%20%283%29.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 PostgreSQL”。

![image](../.gitbook/assets/pgsql-action-0@2x.png)
...
![image](../.gitbook/assets/pgsql-resource-0@2x.png)
...
![image](../.gitbook/assets/pgsql-resource-1@2x.png)
...
![image](../.gitbook/assets/pgsql-action-2@2x.png)

返回规则创建界面，点击 “创建”。

![image](../.gitbook/assets/pgsql-rulesql-2@2x.png)
...
![image](../.gitbook/assets/pgsql-result-1@2x.png)

在规则列表里，可以看到刚才创建的规则的命中次数已经增加了 1:

![image](../.gitbook/assets/pgsql-rulelist-1@2x.png)
...
![image](../.gitbook/assets/mongodb_data_to_store1.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 MongoDB”。

![image](../.gitbook/assets/mongo-action-0@2x.png)
...
![image](../.gitbook/assets/mongodb_data_to_store2.png)

填写资源配置:

数据库名称 填写 “mqtt”，用户名填写 “root”，密码填写 “public”，连接认证源填写 “mqtt” 其他配置保持默认值，然后点击 “测试连接” 按钮，确保连接测试成功。

![image](../.gitbook/assets/mongo-resoure-1.png)

点击 “新建” 按钮，完成资源的创建。

2\). Collection 名称。这个例子我们向刚刚新建的 collection 插入数据，填 “t\_mqtt\_msg”

3\). Payload Tmpl 模板。这个例子里我们向 MongoDB 插入一条数据，模板为空, 插入的数据是上面SQL语句select出来的结果用json格式写入到MongoDB中

![](../.gitbook/assets/mongodb_data_to_store3.png)

在点击 “新建” 完成规则创建

![image](../.gitbook/assets/mongodb_data_to_store4.png)
...
![image](../.gitbook/assets/mongo-rule-result@2x.png)

在规则列表里，可以看到刚才创建的规则的命中次数已经增加了 1:

![image](../.gitbook/assets/mongo-rule-result@3x.png)
...
![image](../.gitbook/assets/redis-action-0@2x.png)
...
![image](../.gitbook/assets/redis-resource-0@2x.png)
...
![image](../.gitbook/assets/redis-resource-2@2x.png)
...
![image](../.gitbook/assets/redis-action-1@2x.png)

返回规则创建界面，点击 “新建”。

![image](../.gitbook/assets/redis-rulesql-1@2x.png)
...
![image](../.gitbook/assets/redis-cli.png)

在规则列表里，可以看到刚才创建的规则的命中次数已经增加了 1:

![image](../.gitbook/assets/redis-rulelist-0@2x.png)
...
![image](../.gitbook/assets/rule_sql%20%282%29.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 Cassandra”。

![image](../.gitbook/assets/cass-action-0@2x.png)
...
![image](../.gitbook/assets/cass-resoure-0.png)

填写资源配置:

Keysapce 填写 “test”，用户名填写 “root”，密码填写 “public” 其他配置保持默认值，然后点击 “测试连接” 按钮，确保连接测试成功。

![image](../.gitbook/assets/cass-resoure-1.png)
...
![image](../.gitbook/assets/cass-resoure-2.png)

在点击 “新建” 完成规则创建

![image](../.gitbook/assets/cass-rule-overview.png)
...
![image](../.gitbook/assets/cass-rule-result@2x.png)

在规则列表里，可以看到刚才创建的规则的命中次数已经增加了 1:

![image](../.gitbook/assets/cass-rule-result@3x.png)
...
![image](../.gitbook/assets/dynamo-rulesql-0.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 DynamoDB”。

![image](../.gitbook/assets/dynamo-action-0.png)
...
![image](../.gitbook/assets/dynamo-action-1.png)

4\). 关联资源的 ID。现在资源下拉框为空，可以点击右上角的 “新建资源” 来创建一个 DynamoDB 资源:

填写资源配置:

![image](../.gitbook/assets/dynamo-resource-1.png)

点击 “新建” 按钮。

返回响应动作界面，点击 “确认”。

![image](../.gitbook/assets/dynamo-action-2.png)

返回规则创建界面，点击 “新建”。

![image](../.gitbook/assets/dynamo-rulesql-1.png)
...
![image](../.gitbook/assets/dynamo-result-0.png)

在规则列表里，可以看到刚才创建的规则的命中次数已经增加了 1:

![image](../.gitbook/assets/dynamo-result-1.png)
...
![](../.gitbook/assets/clickhouse_0.png)
...
![image](../.gitbook/assets/clickhouse_1.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 ClickHouse”。

![image](../.gitbook/assets/clickhouse_2.png)
...
![image](../.gitbook/assets/clickhouse_3.png)

选择 “ClickHouse 资源”。

填写资源配置:

![image](../.gitbook/assets/clickhouse_4.png)
...
![image](../.gitbook/assets/clickhouse_5.png)

返回响应动作界面，点击 “确认”。

![image](../.gitbook/assets/clickhouse_6.png)

在规则列表里，点击 “查看” 按钮或规则 ID 连接，可以预览刚才创建的规则:

![image](../.gitbook/assets/clickhouse_7.png)
...
![image](../.gitbook/assets/clickhouse_8.png)
...
![image](../.gitbook/assets/opentsdb-rulesql-0@2x.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 OpenTSDB”。

![image](../.gitbook/assets/opentsdb-action-0@2x.png)
...
![image](../.gitbook/assets/opentsdb-action-1@2x.png)
...
![image](../.gitbook/assets/opentsdb-resource-1@2x.png)

返回响应动作界面，点击 “确认”。

![image](../.gitbook/assets/opentsdb-action-2@2x.png)

返回规则创建界面，点击 “新建”。

![image](../.gitbook/assets/opentsdb-rulesql-1@2x.png)
...
![image](../.gitbook/assets/opentsdb-rulelist-1@2x.png)
...
![image](../.gitbook/assets/influxdb-rulesql-0@2x.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 InfluxDB”。

![image](../.gitbook/assets/influxdb-action-0@2x.png)
...
![image](../.gitbook/assets/influxdb-action-1@2x.png)

选择 “InfluxDB 资源”:

![image](../.gitbook/assets/influxdb-resource-0@2x.png)
...
![image](../.gitbook/assets/influxdb-resource-1@2x.png)

返回响应动作界面，点击 “确认”。 返回规则创建界面，点击 “新建”。

![image](../.gitbook/assets/influxdb-rulesql-1@2x.png)
...
![image](../.gitbook/assets/influxdb-rulelist-0@2x.png)
...
![image](../.gitbook/assets/timescaledb-rulesql-0@2x.png)

关联动作:

在 “响应动作” 界面选择 “添加”，然后在 “动作” 下拉框里选择 “保存数据到 TimescaleDB”。

![image](../.gitbook/assets/timescaledb-action-0@2x.png)
...
![image](../.gitbook/assets/timescaledb-resource-0@2x.png)
...
![image](../.gitbook/assets/timescaledb-resource-2@2x.png)

返回响应动作界面，点击 “确认”。

![image](../.gitbook/assets/timescaledb-action-1@2x.png)

返回规则创建界面，点击 “新建”。

![image](../.gitbook/assets/timescaledb-rulesql-1@2x.png)
...
![image](../.gitbook/assets/timescaledb-rulelist-0@2x.png)
...
创建 t\_mqtt\_msg 表，关于 TDengine 数据结构以及 SQL 命令参见 [TAOS SQL](https://www.taosdata.com/cn/documentation/taos-sql/#表管理)：
...
![image-20200729163951206](../.gitbook/assets/image-20200729163951206.png)
...
![image](../.gitbook/assets/rule_sql%20%284%29.png)
...
![image-20200729164158454](../.gitbook/assets/image-20200729164158454.png)
...
![image-20200729165651951](../.gitbook/assets/image-20200729165651951.png)

点击 “新建” 按钮。

返回响应动作界面，点击 “确认”。

![image-20200729174211581](../.gitbook/assets/image-20200729174211581.png)
...
EMQ X 规则引擎中有功能强大的_**\**_**发送数据到 Web 服务功能\*\***，可以实现无缝实现上述操作。
...
请求 URL 填写 [http://127.0.0.1:6020/rest/sql](http://127.0.0.1:6020/rest/sql) ，请求方法选择 POST; **还需添加 Authorization 请求头作为认证信息**，请求头的值为 Basic + TDengine {username}:{password} 经过Base64 编码之后的字符串, 例如默认的 root:taosdata 编码后为 `cm9vdDp0YW9zZGF0YQ==`， 填入的值为 `Basic cm9vdDp0YW9zZGF0YQ==`。

![image-20200730093728092](../.gitbook/assets/tdengine-webhook.png)

点击 “新建” 按钮。

返回响应动作界面，点击 “确认”。

![image-20200730093457366](../.gitbook/assets/image-20200730093457366.png)
...
![image-20200729165826748](../.gitbook/assets/image-20200729165826748.png)
...
![image-20200729174914518](../.gitbook/assets/image-20200729174914518.png)
